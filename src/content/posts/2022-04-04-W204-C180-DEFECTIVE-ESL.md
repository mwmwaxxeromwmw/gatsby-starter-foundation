...
The locksmith agreed on installing an emulator as the customer did not want to have this problem again. We programmed the ESL using the existing key and EIS which were brought to us and then installed back on the vehicle with the emulator we programmed. 
